    ...
    <mat-dialog-content>
      <form [formGroup]="areaForm" class="area-form">
        <mat-form-field appearance="outline" class="full-width">
          ...
          <input matInput formControlName="displayName" placeholder="Enter area display name" />
          <mat-icon matPrefix>title</mat-icon>
          <mat-error *ngIf="areaForm.get('displayName')?.hasError('required')">
            Display name is required
          </mat-error>
          <mat-error *ngIf="areaForm.get('displayName')?.hasError('minlength')">
            Display name must be at least 3 characters
          </mat-error>
          <mat-error *ngIf="areaForm.get('displayName')?.hasError('maxlength')">
        ...
        <mat-form-field appearance="outline" class="full-width">
          ...
          <mat-error *ngIf="areaForm.get('actualValue')?.hasError('required')">
            Actual value is required
          </mat-error>
          <mat-error *ngIf="areaForm.get('actualValue')?.hasError('minlength')">
            Actual value must be at least 1 character
          </mat-error>
          <mat-error *ngIf="areaForm.get('actualValue')?.hasError('maxlength')">
        ...
        <mat-form-field appearance="outline" class="full-width">
          ...
          <mat-error *ngIf="areaForm.get('description')?.hasError('maxlength')">
...
export class AreaDialogComponent implements OnInit {
  ...
  private populateForm(area: AreaDisplayData): void {
  ...
  onSubmit(): void {
    if (this.areaForm.valid) {
      ...
      const request: AreaCreateRequest | AreaUpdateRequest = {
